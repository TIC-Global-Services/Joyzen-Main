...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full h-[60dvh] sm:h-[60svh] md:h-[40dvh] lg:h-[65dvh] bg-gradient-to-r from-transparent via-[#D1E0EC] to-[#A9BFCF] flex flex-col justify-between p-5 sm:p-10 lg:p-[4rem] overflow-hidden text-black select-none font-epilogue">
      ...
      <div className="flex px-[0%] md:px-[5%] text-sm text-black flex-col sm:flex-row justify-center sm:justify-between items-center font-semibold gap-4 md:gap-2 relative z-50 w-full tracking-tight">
