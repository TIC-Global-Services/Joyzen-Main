      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-x-5 sm:gap-y-3 text-[32px] sm:text-4xl md:text35xl lg:text-6xl font-bold tracking-tight leading-tight">
          ...
          <motion.div
            ...
            className="order-2 sm:order-2 inline-flex items-center justify-center shadow-md px-6 md:px-7 py-1 sm:py-1.5 md:py-2 rounded-full bg-white/10 backdrop-blur-xs border border-white/80 shadow-[0_4px_20px_rgba(0,0,0,0.03),inset_0_1px_2px_rgba(255,255,255,0.8)]"
          >
        ...
        <motion.div
          ...
          className="mt-3 sm:mt-0 text-[32px] sm:text-4xl md:text-4xl lg:text-6xl font-bold tracking-tight text-[#88CCE1] leading-none"
        >
          Health Journey
        </motion.div>
      </motion.div>
