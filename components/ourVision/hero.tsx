...
export default function Hero() {
  return (
    <section className="relative w-full min-h-[88vh] sm:min-h-screen flex flex-col justify-end pt-24 sm:pt-28 md:pt-32 pb-14 sm:pb-20 md:pb-24 px-[5%] overflow-hidden select-none">
      ...
      <div className="absolute bottom-30 sm:top-50 lg:-top-28 -right-46 sm:-right-[35%] lg:-right-[15%] w-[150%] sm:w-[95%] md:w-[150%] lg:w-[98%]  pointer-events-none z-0">
        <motion.div
          initial={{ opacity: 0, scale: 0.95, y: 20 }}
          animate={{ opacity: 1, scale: 1, y: 0 }}
          transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}
          className="relative w-full aspect-[17/10]"
        >
