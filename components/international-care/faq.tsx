            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* Icon Indicator (Circled Plus (+) like image) */}
                  <div className="absolute right-5 sm:right-7 top-1/2 -translate-y-1/2 flex items-center justify-center text-black">
                    <motion.svg
                ...
                <AnimatePresence initial={false}>
                  {isOpen && (
                    ...
                    >
                      <div className="px-6 sm:px-12 pb-6 sm:pb-7 pt-0 text-sm sm:text-base text-center text-black font-normal leading-relaxed">
                        {item.answer}
                      </div>
                    </motion.div>
                  )}
